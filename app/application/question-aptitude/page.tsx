    ...
    { field: "question1",  questionNum: 1,  description: (
        <div>
            <span className="text-pretty">
                1.ให้น้องอธิบายลำดับขั้นตอนการทำงานของโปรแกรมที่ใช้หา จำนวนเฉพาะ (เลขที่มากกว่า 1 และไม่มีเลขใดหารลงตัวนอกจาก 1 กับตัวมันเอง) ทั้งหมดที่อยู่ระหว่างค่า A ถึง B (รวม A และ B ด้วย) โดยต้องแสดงเลขที่เจอทั้งหมดเรียงจากน้อยไปหามาก หากไม่เจอเลยให้ตอบว่า NONE และบรรทัดสุดท้ายต้องแสดง ผลรวม ของเลขเหล่านั้นด้วย เช่น เมื่อ<br />
                <div className="ml-3">
                    1 ) A เป็น 1 และ B เป็น 10 คำตอบบรรทัดแรกจะเป็น 2 3 5 7 และคำตอบบรรทัดที่สองจะเป็น 17 <br />
                    2) A เป็น 8 และ B เป็น 10 คำตอบบรรทัดแรกจะเป็น NONE และคำตอบบรรทัดที่สองจะเป็น 0 <br />
    ...
    { field: "question7",  questionNum: 7,  description: (
        <div>
             <span className="text-pretty">
                ...
                <strong>พี่ ๆ มีหุ่นยนต์มาให้น้องเลือก 2 ตัว ในการเอาไปทำภารกิจ เก็บซากหุ่นยนต์ โดยให้น้องเลือกหุ่นยนต์ตัวใดตัวหนึ่ง และอธิบายว่าทำไมน้องถึงเลือกหุ่นยนต์ตัวนั้น รวมถึงวิธีการที่น้องจะทำภารกิจนี้ให้สำเร็จ</strong><br />
                {/* ยังไม่ได้เพอ่มรูปน้า */}
                <div>
                    <strong>หุ่นยนต์ A</strong><br />
                    Code name: สาส์นจากสวรรค์หุ่นยนต์ผู้ซึ่งปลดแอกจากการจองจำของปีศาจจากขุมนรก<br />
                    <img src="https://i.postimg.cc/L88RTbv4/Screenshot-2026-02-20-175750.png" height="300px"></img>
                </div>
                <div>
                    <strong>หุ่นยนต์ B</strong><br />
                    Code name: ราชาปีศาจหุ่นยนต์ผู้ซึ่งทำลายล้างทุกสิ่งผู้ที่ปกครองทุกอย่างผู้ที่เกิดมาเพื่อสร้างความโกลาหลแก่โลกใบนี้    <br />
                    <img src="https://i.postimg.cc/P5P9Ns29/Screenshot-2026-02-20-192144.png" height="300px"></img>
                </div>
            </span>
        </div>
    ), question: "Aptitude_Test7",  placeholder: "" },
